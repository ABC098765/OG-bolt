...
const Header = () => {
  ...
  return (
    <header className="bg-red-50/20 dark:bg-gray-800/20 backdrop-blur-md shadow-md fixed top-0 left-0 right-0 z-50 rounded-b-2xl mx-4">
      {/* Top bar */}
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            {authState.isAuthenticated ? (
              ...
              <button 
                ...
                className="bg-gradient-to-r from-orange-500 to-orange-600 text-white px-8 py-2.5 rounded-full hover:from-orange-600 hover:to-orange-700 active:scale-95 transition-all duration-200 font-semibold shadow-lg hover:shadow-xl whitespace-nowrap flex items-center justify-center min-w-max"
              >
            ...
            <div className="flex flex-col space-y-4 pt-4">
              ...
              {authState.isAuthenticated ? (
                ...
                <button 
                  ...
                  className="bg-gradient-to-r from-orange-500 to-orange-600 text-white px-8 py-3 rounded-full hover:from-orange-600 hover:to-orange-700 active:scale-95 transition-all duration-200 font-semibold shadow-lg hover:shadow-xl w-full flex items-center justify-center gap-2"
                >
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
                  </svg>
